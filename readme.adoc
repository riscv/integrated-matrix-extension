...
This repository hosts the source code of the Integrated Matrix Extension.
...
`git clone --recurse-submodules https://github.com/riscv/integrated-matrix-extension.git`

=== Building the Documentation

To start the build process, run `cd ./integrated-matrix-extension && make build`.
