...
)
{
    ...
    assert(requested_lambda != 0);
    assert(requested_lambda <= 64 &&
           (requested_lambda & (requested_lambda - 1)) == 0);
    const size_t lambda =
        __riscv_vsetlambda_e64(requested_lambda);
    ...
    if (emul_c == 16) {
        ...
        vfloat64m8_t zero8 =
            __riscv_vfmv_v_f_f64m8(0.0, 8 * L);
        vfloat64m16_t c00 =
            __riscv_ime_vpair_f64m16(zero8, zero8);       // <3>

        for (size_t k = 0; k < K; k += lambda) {
            vfloat64m1_t a0 = __riscv_vle64_v_f64m1(A, L);
            A += stepA;
            vfloat64m1_t b0 = __riscv_vle64_v_f64m1(B, L);
            B += stepB;
        ...
        const size_t stepB = N * lambda;
        vfloat64m8_t c00 =
            __riscv_vfmv_v_f_f64m8(0.0, 8 * L);           // <4>
        vfloat64m8_t c10 =
            __riscv_vfmv_v_f_f64m8(0.0, 8 * L);
        ...
        for (size_t k = 0; k < K; k += lambda) {
            ...
            vfloat64m1_t a1 = __riscv_vle64_v_f64m1(A, L);
            A += stepA;
        ...
        vfloat64m4_t c00 =
            __riscv_vfmv_v_f_f64m4(0.0, 4 * L);
        vfloat64m4_t c10 =
            __riscv_vfmv_v_f_f64m4(0.0, 4 * L);
        vfloat64m4_t c01 =
            __riscv_vfmv_v_f_f64m4(0.0, 4 * L);
        ...
        for (size_t k = 0; k < K; k += lambda) {
            ...
            vfloat64m1_t b1 = __riscv_vle64_v_f64m1(B, L);
            B += stepB;
        ...
        const size_t stepB = N/2 * lambda;
        vfloat64m2_t c00 =
            __riscv_vfmv_v_f_f64m2(0.0, 2 * L);
        vfloat64m2_t c10 =
            __riscv_vfmv_v_f_f64m2(0.0, 2 * L);
        vfloat64m2_t c20 =
            __riscv_vfmv_v_f_f64m2(0.0, 2 * L);
        ...
        for (size_t k = 0; k < K; k += lambda) {
            ...
            vfloat64m1_t a2 = __riscv_vle64_v_f64m1(A, L);
            A += stepA;
            c20 = __riscv_vfmmacc_vv_f64m2(c20, a2, b0, L);
            vfloat64m1_t a3 = __riscv_vle64_v_f64m1(A, L);
            A += stepA;
        ...
        for (size_t k = 0; k < K; k += lambda) {
            ...
            vfloat64m1_t b2 = __riscv_vle64_v_f64m1(B, L);
            B += stepB;
            ...
            vfloat64m1_t b3 = __riscv_vle64_v_f64m1(B, L);
            B += stepB;
