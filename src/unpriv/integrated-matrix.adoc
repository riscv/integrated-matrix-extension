...
corresponding three-bit encoding in the instruction-immediate field; no
runtime `LAMBDA` argument is required.
...
vint32m2_t __riscv_vmtl_v_i32m2_m (vbool16_t mask, const int32_t *base, size_t ld, size_t vl);
/* vmts.v masked: */
...
vfloat16m2_t __riscv_vmtl_v_f16m2_as_e32_m(vbool16_t mask, const uint32_t *base, size_t ld, size_t vl);
