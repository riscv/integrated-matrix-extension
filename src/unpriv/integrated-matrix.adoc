...
==== Example of a fully portable matrix multiply code

<<microdgemm-example>> illustrates how one executable can select among
five microkernel organizations according to the value of `EMUL_C`.
...
illustrates the general approach to low overhead portable code.
