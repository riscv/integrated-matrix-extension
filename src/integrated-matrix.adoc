...
* The _accumulator_ C is stored in a vector register group with element width SEW.
  Its register group multiplier MUL~C~ is determined by the tile geometry:
  MUL~C~ = (VLEN / SEW) / λ^2^, where λ is the K dimension given by the `lambda[2:0]` field in the `vtype` CSR.
  The C register group may start at any vector register index that is MUL~C~-aligned.
...
and `vfqwimmacc.vv` respectively.  `altfmt_A` and `altfmt_B` retain their
signedness meaning; `altfmt` selects the FP accumulator format.
...
| vfwimmacc | 16 | 8  | 0 | Int8  | 1 | UInt8 | 0 | FP16  | Zvvfmmmxi8h     | Zvvfmmnxi8h
| vfwimmacc | 16 | 8  | 1 | UInt8 | 0 | Int8  | 0 | FP16  | Zvvfmmmxi8h     | Zvvfmmnxi8h
| vfwimmacc | 16 | 8  | 1 | UInt8 | 1 | UInt8 | 0 | FP16  | Zvvfmmmxi8h     | Zvvfmmnxi8h
| vfwimmacc | 16 | 8  | 0 | Int8  | 0 | Int8  | 1 | BF16  | Zvvfmmmxi8bf16  | Zvvfmmnxi8bf16
| vfwimmacc | 16 | 8  | 0 | Int8  | 1 | UInt8 | 1 | BF16  | Zvvfmmmxi8bf16  | Zvvfmmnxi8bf16
| vfwimmacc | 16 | 8  | 1 | UInt8 | 0 | Int8  | 1 | BF16  | Zvvfmmmxi8bf16  | Zvvfmmnxi8bf16
| vfwimmacc | 16 | 8  | 1 | UInt8 | 1 | UInt8 | 1 | BF16  | Zvvfmmmxi8bf16  | Zvvfmmnxi8bf16
...
| vfqwimmacc | 16 | 4  | 0 | Int4  | 1 | UInt4 | 0 | FP16  | Zvvfmmmxi4h     | Zvvfmmnxi4h
| vfqwimmacc | 16 | 4  | 1 | UInt4 | 0 | Int4  | 0 | FP16  | Zvvfmmmxi4h     | Zvvfmmnxi4h
| vfqwimmacc | 16 | 4  | 1 | UInt4 | 1 | UInt4 | 0 | FP16  | Zvvfmmmxi4h     | Zvvfmmnxi4h
| vfqwimmacc | 16 | 4  | 0 | Int4  | 0 | Int4  | 1 | BF16  | Zvvfmmmxi4bf16  | Zvvfmmnxi4bf16
| vfqwimmacc | 16 | 4  | 0 | Int4  | 1 | UInt4 | 1 | BF16  | Zvvfmmmxi4bf16  | Zvvfmmnxi4bf16
| vfqwimmacc | 16 | 4  | 1 | UInt4 | 0 | Int4  | 1 | BF16  | Zvvfmmmxi4bf16  | Zvvfmmnxi4bf16
| vfqwimmacc | 16 | 4  | 1 | UInt4 | 1 | UInt4 | 1 | BF16  | Zvvfmmmxi4bf16  | Zvvfmmnxi4bf16
| vfqwimmacc | 32 | 8  | 0 | Int8  | 0 | Int8  | 0 | FP32  | Zvvfmmmxi8w     | Zvvfmmnxi8w
| vfqwimmacc | 32 | 8  | 0 | Int8  | 1 | UInt8 | 0 | FP32  | Zvvfmmmxi8w     | Zvvfmmnxi8w
| vfqwimmacc | 32 | 8  | 1 | UInt8 | 0 | Int8  | 0 | FP32  | Zvvfmmmxi8w     | Zvvfmmnxi8w
| vfqwimmacc | 32 | 8  | 1 | UInt8 | 1 | UInt8 | 0 | FP32  | Zvvfmmmxi8w     | Zvvfmmnxi8w
...
stem:[C_{m,n} \leftarrow C_{m,n} + \sum_{s=0}^{S-1} \text{scale_A}_{m,s} \times \text{scale_B}_{n,s} \times \left( \sum_{k \in \text{block } s} A_{m,k} \times B_{k,n} \right)]
...
|Zvvfmmmxi8h     ^| 32 ^| —               | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | IEEE binary16
|Zvvfmmmxi8bf16  ^| 32 ^| —               | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | BFloat16
|Zvvfmmmxi8w     ^| 32 ^| —               | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | IEEE binary32
|Zvvfmmmxi4h     ^| 32 ^| —               | MXINT4 (E8M0-scaled Int4/UInt4), MXINT4 | IEEE binary16
|Zvvfmmmxi4bf16  ^| 32 ^| —               | MXINT4 (E8M0-scaled Int4/UInt4), MXINT4 | BFloat16
|Zvvfmmnxi8h     ^| 16 ^| Zvvfmmmxi8h     | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | IEEE binary16
|Zvvfmmnxi8bf16  ^| 16 ^| Zvvfmmmxi8bf16  | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | BFloat16
|Zvvfmmnxi8w     ^| 16 ^| Zvvfmmmxi8w     | MXINT8 (E8M0-scaled Int8/UInt8), MXINT8 | IEEE binary32
|Zvvfmmnxi4h     ^| 16 ^| Zvvfmmmxi4h     | MXINT4 (E8M0-scaled Int4/UInt4), MXINT4 | IEEE binary16
|Zvvfmmnxi4bf16  ^| 16 ^| Zvvfmmmxi4bf16  | MXINT4 (E8M0-scaled Int4/UInt4), MXINT4 | BFloat16
|===
...
K_effective = λ × 2 × LMUL.
VL selects how many columns of B (and C) are updated; VL must be a multiple of K_effective.
`altfmt_A` and `altfmt_B` select the signedness of the A and B inputs (0 = signed,
1 = unsigned).  `altfmt` selects the FP format of the accumulator C.
+
...
foreach (j from 0 to (N - 1)) {
  foreach (i from 0 to (M - 1)) {
    ...
    foreach (s from 0 to (S - 1)) {
      ...
      // Exact integer dot product within block
      let k_lo : int = s * block_size;
      let k_hi : int = min((s + 1) * block_size, K_eff) - 1;
      var int_sum : int = 0;
      foreach (k from k_lo to k_hi) {
