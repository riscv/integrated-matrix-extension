...
gap.
To reserve encoding space for this, a 4th consecutive opcode has been set
aside in each encoding space: funct6 = 0x3b in OPIVV (following
`vmmacc.vv` / `vwmmacc.vv` / `vqwmmacc.vv` at 0x38–0x3a) and funct6 = 0x17
in OPFVV (following `vfmmacc.vv` / `vfwmmacc.vv` / `vfqwmmacc.vv` at
0x14–0x16).
====
