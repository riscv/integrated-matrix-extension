...
The signedness of each input is controlled independently by `altfmt_A` and `altfmt_B` (0 = signed, 1 = unsigned; see <<_alternate_formats_for_inputs_altfmt_a_altfmt_b>>); the accumulator C is always signed.
