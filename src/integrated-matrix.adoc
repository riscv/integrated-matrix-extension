...
| L_A = LMUL × VLEN ÷ (SEW ÷ W)         | Total A or B tile elements across LMUL registers.  L_A is a local helper used only in this table.
...
elements are stored in column-major order. This choice allows the implementation of the
