...
// The group begins at sub-dot-product index g0 and spans g_len consecutive
// sub-dot-products. Each sub-dot-product contributes W scalar products, so
// the full group corresponds to a dot product of two vectors with
// g_len × W elements.
//
