...
stem:[\text{scale_A}_{i,s}] and stem:[\text{scale_B}_{j,s}] are the
per-block scales held in `v0` for row _i_ and column _j_ of block _s_
according to the scale format associated with the input data type.
